...
import { ModalClass, FormClass, TextareaClass, InputClass } from "../../core/class/elements.class";
import React from 'react';
import BaseView from "../base.view";
import { Link } from 'react-router-dom';


export class ListPhaseProjetView extends BaseView{
                    ...
                    item => {
                        return <div key={item.id} className="col-xl-4 m-1 col-md-4 col-lg-6 col-12 mb-4 mt-2 card">
                            ...
                            <div className="row justify-content-center">
                                <Link to={"/phases/" + item.id + "/configs"} className="btn btn-outline-dark m-1 col-12 col-md-5 col-lg-5 ">
                                    paramétrage
                                         </Link>

                                <Link to={"/phase/" + item.id} className="btn btn-outline-primary m-1 col-12 col-md-5 col-lg-5">
                                    Gestion
                                </Link>
