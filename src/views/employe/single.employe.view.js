...
import { ModalClass, FormClass } from '../../core/class/elements.class';
import { InputClass } from './../../core/class/elements.class';

export default class SingleEmployeView extends BaseView{
    UNSAFE_componentWillMount() {
        const Fields = {
            inputs: [
                ...
                new InputClass({
                    name: "naissance", titre: "Date de naissance", type: "datepicker", icon: "calendar-alt", errors: this.props.data.formMessage.errors["naissance"],
                    handleChange: this.props.data.formAction.handleField
                }),
                new InputClass({
        ...
        const SingleData = new FetchingDataClass({
            type: "single",
            singleton: {},
            pSingleDataFrameComponent: PProfileView
        });
